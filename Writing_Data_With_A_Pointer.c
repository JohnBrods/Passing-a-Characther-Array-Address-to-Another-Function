                                                    ...
                                                    //THE VHARACTER ARRAY IS IN MAIN SO A POINTER IS USED TO PASS ADDRESS TO FUNCTION
...
void Initialise_SDCARD(){
     ...
     // Delay_ms(400);
      ...
      /*for (x=412; x<513; x++, sdcardbuffer_Y_position +=30 ){  //LAST 100 BYTES
          Write_Number(Boot_SectorBuffer[x],sdcardbuffer_X_position,sdcardbuffer_Y_position,Black);
          if (sdcardbuffer_Y_position>=440){
             sdcardbuffer_Y_position = 30;
             sdcardbuffer_X_position += 100;
...
void main(){
 ...
 unsigned short Character_Array[] = {13,84,72,65,78,75,83,32,52,32,87,65,84,67,72,73,78,71,46,13,68,79,78,84,32,70,79,82,71,69,84,32,84,79,32,72,73,84,32,76,73,75,69,13,
     ...
     ByteToHex(New_Data28, HexString28);               //DISPLAY HEX VALUES ON SCREEN AS YOU WOULD SEE IT IN HxD EDITOR  'LITTL
     ...
     Write_Number(Pointer,360,ypos,Yellow);  //Write Address Of Character Array   See Top Of Main For Pointer And What It Points To.
     ypos +=32;
     //Pointer2 = 1;
     Write_Number(Pointer2[1],360,ypos,Black);  //WRITE CHARACTER 1 OF CHARACTER ARRAY. NOT CHARACTER ZERO SINCE I KNOW ZERO = 13
     
     //ypos +=32;
     ...
     //////////////////READ MESSAGE SECTOR TO DISPLAY IT BELOW//////////////////////////////////////////////////
      ...
      for (x=0; x<100; x++, sdcardbuffer_Y_position +=30 ){       //FIRST 100 BYTES OF 512 BUFFER
      ...
      sdcardbuffer_Y_position = 30;
       ...
       for (x=412; x<512; x++, sdcardbuffer_Y_position +=30 ){     //LAST 100 BYTES OF 512 BUFFER
        Write_Number(dataBuffer[x],sdcardbuffer_X_position,sdcardbuffer_Y_position,Black);
        if (sdcardbuffer_Y_position>=440){
           sdcardbuffer_Y_position = 30;
           sdcardbuffer_X_position += 100;
